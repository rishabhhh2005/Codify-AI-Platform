...
import { Clock, Lightbulb, Trophy, ChevronRight, Brain } from 'lucide-react';
...
export default function SessionDashboard({
  ...
  return (
    <div className="flex flex-col gap-3 p-3 h-full bg-surface-1 border-b border-border">
      {/* Session meta row */}
      <div className="flex items-center gap-2 flex-wrap">
        {questions?.length > 1 && questions.map((q, idx) => (
          <button
            ...
            className={`px-3 py-1 text-xs font-bold font-mono tracking-wider rounded cursor-pointer transition-all ${
